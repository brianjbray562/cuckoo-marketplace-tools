...
RULE 5 — ONLY include features, materials, colors, and specs that are either (a) explicitly stated in the original Amazon title, or (b) found in the VERIFIED PRODUCT DATA provided from the internal product database. Do NOT invent or assume features. If the original title is sparse (e.g. just brand + model + "Rice Cooker"), use the product database data provided to find real specs, features, capacity, color, and technology type. This is strongly preferred over generating thin titles.

EXAMPLES (follow this style exactly):

Input: "CUCKOO CRP-P0609S 6 Cup Electric Heating Pressure Rice Cooker & Warmer with Nonstick Inner Pot, Black"
...
Input: "CUCKOO CRP-JHT1010F Induction Heating Twin Pressure Rice Cooker & Warmer 10 Cup White"
...
// Product database: 46 verified rice cooker models (Source: Rice_Cooker_Categorization.xlsx, updated March 2026)
// Fields: type, heating, pressure, cupSize, color, cookingModes, otherMenuModes, innerPot, features, asin
const PRODUCT_DB = {
"CR-0301C":{type:"Basic",heating:"Heating Plate",pressure:false,cupSize:"3 Cup Uncooked / 6 Cup Cooked",color:"White",innerPot:"Nonstick",features:[],asin:"B0G5TQS5R8"},
"CR-0351FR":{type:"Micom",heating:"Heating Plate",pressure:false,cupSize:"3 Cup Uncooked / 6 Cup Cooked",color:"Red",cookingModes:"5",innerPot:"Nonstick",features:["Turbo Mode","Preset Timer (13 Hours)","Water Capture"],asin:"B00CCVNX0O"},
"CR-0375FG":{type:"Micom",heating:"Heating Plate",pressure:false,cupSize:"3 Cup Uncooked / 6 Cup Cooked",color:"Gray",cookingModes:"8",otherMenuModes:"1",innerPot:"Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture"],asin:"B0CKWGX2J6"},
"CR-0375FW":{type:"Micom",heating:"Heating Plate",pressure:false,cupSize:"3 Cup Uncooked / 6 Cup Cooked",color:"White",cookingModes:"8",otherMenuModes:"1",innerPot:"Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture"],asin:"B0B4MYBLZQ"},
"CR-0601C":{type:"Basic",heating:"Heating Plate",pressure:false,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"White",innerPot:"Nonstick",features:[],asin:"B0FPYDZT52"},
"CR-0631F":{type:"Micom",heating:"Heating Plate",pressure:false,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"Silver",cookingModes:"6",innerPot:"Nonstick",features:["Turbo Mode","Preset Timer (13 Hours)","Water Capture"],asin:"B00D2CL37W"},
"CR-0632F":{type:"Micom",heating:"Heating Plate",pressure:false,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"Pink",cookingModes:"6",innerPot:"Nonstick",features:["Turbo Mode","Preset Timer (13 Hours)","Water Capture"],asin:"B0831RL6XK"},
"CR-0633F":{type:"Micom",heating:"Heating Plate",pressure:false,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"White",cookingModes:"6",innerPot:"Nonstick",features:["Turbo Mode","Preset Timer (13 Hours)","Water Capture"],asin:"B0C363Y7HX"},
"CR-0641F":{type:"Micom",heating:"Heating Plate",pressure:false,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"White",cookingModes:"8",innerPot:"Nonstick",features:["Auto Clean","Preset Timer (13 Hours)","Water Capture"],asin:"B0CHG3HVJX"},
"CR-0655F":{type:"Micom",heating:"Heating Plate",pressure:false,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"Red",cookingModes:"8",innerPot:"Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture"],asin:"B01MQWFGKG"},
"CR-0671V":{type:"Basic",heating:"Heating Plate",pressure:false,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"White",cookingModes:"1",innerPot:"Nonstick",features:[],asin:"B01LYLW8P6"},
"CR-0675FG":{type:"Micom",heating:"Heating Plate",pressure:false,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"Gray",cookingModes:"9",innerPot:"Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture"],asin:"B0B5B3QBV1"},
"CR-0675FW":{type:"Micom",heating:"Heating Plate",pressure:false,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"White",cookingModes:"9",innerPot:"Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture"],asin:"B08WFNV82W"},
"CR-0810F":{type:"Micom",heating:"Heating Plate",pressure:false,cupSize:"8 Cup Uncooked / 16 Cup Cooked",color:"White",cookingModes:"7",innerPot:"Nonstick",features:["Auto Clean","Preset Timer (4 Hours)","Water Capture"],asin:"B0842DDJL4"},
"CR-1020F":{type:"Micom",heating:"Heating Plate",pressure:false,cupSize:"10 Cup Uncooked / 20 Cup Cooked",color:"White",cookingModes:"14",innerPot:"Nonstick",features:["Preset Timer (12 Hours)","Water Capture"],asin:"B083GBLDF3"},
"CR-1095":{type:"Basic",heating:"Heating Plate",pressure:false,cupSize:"10 Cup Uncooked / 20 Cup Cooked",color:"White",cookingModes:"2",innerPot:"Nonstick",features:["Water Capture"],asin:"B0CYNVF15J"},
"CR-3032":{type:"Commerical",heating:"Heating Plate",pressure:false,cupSize:"30 Cup Uncooked / 60 Cup Cooked",color:"Stainless",cookingModes:"3",innerPot:"Nonstick",features:["Water Capture"],asin:"B00U1XN4L8"},
"CR-3055":{type:"Commerical",heating:"Heating Plate",pressure:false,cupSize:"30 Cup Uncooked / 60 Cup Cooked",color:"Stainless",cookingModes:"3",innerPot:"Nonstick",features:["Water Capture"],asin:"B0CQTTC1VG"},
"CR-HA0810FW":{type:"Induction + Non Pressure",heating:"Induction Heat",pressure:false,cupSize:"8 Cup Uncooked / 16 Cup Cooked",color:"White",cookingModes:"12",innerPot:"Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide (KOR, ENG, CHIN)","Ideal for Delicate Grains"],asin:"B0GJJDG93W"},
"CR-HA0810FG":{type:"Induction + Non Pressure",heating:"Induction Heat",pressure:false,cupSize:"8 Cup Uncooked / 16 Cup Cooked",color:"Gray",cookingModes:"12",innerPot:"Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide (KOR, ENG, CHIN)","Ideal for Delicate Grains"],asin:"B0GJGDC36Z"},
"CRP-BHSS0609F":{type:"Induction + Pressure",heating:"Induction Heat",pressure:true,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"White",cookingModes:"13",innerPot:"Stainless Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide"],asin:"B00NJ12KAU"},
"CRP-CHSS1009FN":{type:"Induction + Pressure",heating:"Induction Heat",pressure:true,cupSize:"10 Cup Uncooked / 20 Cup Cooked",color:"Silver",cookingModes:"15",innerPot:"Stainless Nonstick Eco Curved",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide"],asin:"B00NUB6ARI"},
"CRP-DHSR0609FD":{type:"Induction + Pressure",heating:"Induction Heat",pressure:true,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"Dark Gray",cookingModes:"13",innerPot:"Stainless Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide"],asin:"B0721ZMW8K"},
"CRP-EHSS0309FG":{type:"Induction + Pressure",heating:"Induction Heat",pressure:true,cupSize:"3 Cup Uncooked / 6 Cup Cooked",color:"Gold",cookingModes:"16",innerPot:"Stainless Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide"],asin:"B072NFGLSV"},
"CRP-HS0657FW":{type:"Induction + Pressure",heating:"Induction Heat",pressure:true,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"White",cookingModes:"14",innerPot:"Black Shine Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide (KOR only)"],asin:"B071H1FXFC"},
"CRP-HZ0683FR":{type:"Induction + Pressure",heating:"Induction Heat",pressure:true,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"Black",cookingModes:"18",innerPot:"Black Shine Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide"],asin:"B071KMD3GY"},
"CRP-JHR0609F":{type:"Induction + Pressure",heating:"Induction Heat",pressure:true,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"Copper",cookingModes:"14",innerPot:"Stainless Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide"],asin:"B0BBP8X8GG"},
"CRP-JHR1009F":{type:"Induction + Pressure",heating:"Induction Heat",pressure:true,cupSize:"10 Cup Uncooked / 20 Cup Cooked",color:"Copper",cookingModes:"14",innerPot:"Black Shine Eco-Stainless Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide"],asin:"B0BBPPLBWB"},
"CRP-LHTAR0609FB":{type:"Twin Pressure + Induction",heating:"Induction Heat",pressure:true,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"Black",cookingModes:"19",innerPot:"Stainless Steel",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide"],asin:"B0GPHBR65G"},
"CRP-LHTAR0609FW":{type:"Twin Pressure + Induction",heating:"Induction Heat",pressure:true,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"White",cookingModes:"19",innerPot:"Stainless Steel",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide"],asin:"B0GPGXCYBW"},
"CRP-LHTR0609FW":{type:"Twin Pressure + Induction",heating:"Induction Heat",pressure:true,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"White",cookingModes:"20",innerPot:"Stainless Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide"],asin:"B08DP4TGNN"},
"CRP-LHTR1009FW":{type:"Twin Pressure + Induction",heating:"Induction Heat",pressure:true,cupSize:"10 Cup Uncooked / 20 Cup Cooked",color:"White",cookingModes:"20",innerPot:"Black Shine Eco-Stainless Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide"],asin:"B08F25FVY6"},
"CRP-MHTR0309F":{type:"Twin Pressure + Induction",heating:"Induction Heat",pressure:true,cupSize:"3 Cup Uncooked / 6 Cup Cooked",color:"White",cookingModes:"11",innerPot:"Stainless Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide"],asin:"B09XPC3MNM"},
"CRP-N0681FV":{type:"Pressure",heating:"Heating Plate",pressure:true,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"Red",cookingModes:"15",innerPot:"Marble-Coated Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide"],asin:"B072NFM485"},
"CRP-OHTR0609F":{type:"Twin Pressure + Induction",heating:"Induction Heat",pressure:true,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"White",cookingModes:"13",innerPot:"Stainless Nonstick",features:["Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide (KOR & ENG)","Silent Pressure System"],asin:"B0FXNYNHMX"},
"CRP-P0609S":{type:"Pressure",heating:"Heating Plate",pressure:true,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"Black",cookingModes:"13",innerPot:"Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide"],asin:"B01JRTZVVM"},
"CRP-P1009SB":{type:"Pressure",heating:"Heating Plate",pressure:true,cupSize:"10 Cup Uncooked / 20 Cup Cooked",color:"Black",cookingModes:"13",innerPot:"Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide"],asin:"B00XQEM2E4"},
"CRP-P1009SW":{type:"Pressure",heating:"Heating Plate",pressure:false,cupSize:"10 Cup Uncooked / 20 Cup Cooked",color:"White",cookingModes:"13",innerPot:"Nonstick",features:["Preset Timer (13 Hours)","Water Capture"],asin:"B00XQEM2BM"},
"CRP-PHTR0609F":{type:"Twin Pressure + Induction",heating:"Induction Heat",pressure:true,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"Silver",cookingModes:"12",innerPot:"Stainless Nonstick",features:["Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide (KOR & ENG)","Silent Pressure System"],asin:"B0FXNXR46R"},
"CRP-PK1001S":{type:"Pressure",heating:"Heating Plate",pressure:true,cupSize:"10 Cup Uncooked / 20 Cup Cooked",color:"Silver",cookingModes:"19",innerPot:"Black Shine Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture"],asin:"B082QV3J6K"},
"CRP-RT0609FB":{type:"Twin Pressure",heating:"Heating Plate",pressure:true,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"Black",cookingModes:"13",innerPot:"X-wall Diamond Coating",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide"],asin:"B087H24T6G"},
"CRP-RT0609FW":{type:"Twin Pressure",heating:"Heating Plate",pressure:false,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"White",cookingModes:"13",innerPot:"X-wall Diamond Coating",features:["Preset Timer (13 Hours)","Water Capture"],asin:"B087H9ZVKD"},
"CRP-ST0609FG":{type:"Twin Pressure",heating:"Heating Plate",pressure:true,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"Gray",cookingModes:"18",innerPot:"Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide"],asin:"B0B7P646FD"},
"CRP-ST0609FW":{type:"Twin Pressure",heating:"Heating Plate",pressure:false,cupSize:"6 Cup Uncooked / 12 Cup Cooked",color:"White",cookingModes:"18",innerPot:"Nonstick",features:["Preset Timer (13 Hours)","Water Capture"],asin:"B0B44XTV71"},
"CRP-ST1009FG":{type:"Twin Pressure",heating:"Heating Plate",pressure:true,cupSize:"10 Cup Uncooked / 20 Cup Cooked",color:"Gray",cookingModes:"15",innerPot:"Nonstick",features:["Auto Clean","Turbo Mode","Preset Timer (13 Hours)","Water Capture","Voice Guide"],asin:"B0B7Q6DF32"},
"CRP-ST1009FW":{type:"Twin Pressure",heating:"Heating Plate",pressure:false,cupSize:"10 Cup Uncooked / 20 Cup Cooked",color:"White",cookingModes:"15",innerPot:"Nonstick",features:["Preset Timer (13 Hours)","Water Capture"],asin:"B0BHMW3BQB"},
};
...
function formatProductContext(p) {
  ...
  if (p.cookingModes) lines.push(`Cooking Modes: ${p.cookingModes}`);
  ...
  lines.push(`\nCRITICAL: The data above is from an internal verified database and is MORE ACCURATE than cuckooamerica.com. Do NOT add features, technologies, or specs that are NOT listed above. The database is the single source of truth for all product specs.`);
  return lines.join("\n");
}
  ...
  rice_cooker: {
    ...
    fields: [
      ...
      { key: "material", label: "Inner Pot Material", type: "select", options: [
        { value: "Nonstick", label: "Nonstick" }, { value: "Stainless Steel", label: "Stainless Steel" }, { value: "Ceramic", label: "Ceramic" },
      ]},
    ...
    features: ["Keep Warm", "Delay Timer", "Auto Clean", "Quick Rice", "Voice Guide", "Smart Algorithm", "Steamer Basket", "Multi-Cook", "Low Carb", "Turbo Mode", "GABA Rice", "Slow Cook"],
...
function hasBadCupCount(title) {
  if (!title) return false;
  // Match digit(s) + hyphen/space + "Cup" not followed by Uncooked/Cooked
  // Word boundary before digit prevents matching "Cupcake" etc.
  const cupPattern = /\b(\d+)-?Cup(?!\s*(?:Uncooked|Cooked))\b/i;
  const match = title.match(cupPattern);
  if (!match) return false;
  // Verify it's a capacity reference (1-30 cups typical for rice cookers)
...
export default function App() {
  ...
  const handleLogin = useCallback(() => { const user = authUser.trim().toLowerCase(); if (CREDENTIALS[user] && CREDENTIALS[user] === authPass) { setAuthState("authenticated"); setIsAdmin(user === "admin"); setLoggedInUser(user); setAuthError(""); setAuthUser(""); setAuthPass(""); } else { setAuthError("Invalid username or password"); } }, [authUser, authPass]);
  ...
  const optimizeBulk = useCallback(async () => {
    ...
    const callApi = async (title, keys) => {
      ...
      const res = await fetch("https://api.anthropic.com/v1/messages", {
        method: "POST", headers: { "Content-Type": "application/json", "anthropic-beta": "interstitial-1" }, signal: controller.signal,
        body: JSON.stringify({
          model: "claude-sonnet-4-6", max_tokens: 3000, temperature: 0.3, system: SYSTEM_PROMPT + catRules,
    ...
    try {
      for (let i = 0; i < titles.length; i++) {
        ...
        try {
          let merged;
          if (sel.length >= 6) {
            const mid = Math.ceil(sel.length / 2);
            const [r1, r2] = await Promise.all([callApi(titles[i], sel.slice(0, mid)), callApi(titles[i], sel.slice(mid))]);
            merged = { amazon_audit: r1.amazon_audit || r2.amazon_audit, conversions: { ...(r1.conversions || {}), ...(r2.conversions || {}) } };
          } else {
            merged = await callApi(titles[i], sel);
          }
  ...
  const bkAutoFill = useCallback((modelNum) => {
    ...
    // Map DB innerPot to simplified select options
    const matMap = (v) => { if (!v) return ""; const lv = v.toLowerCase(); if (lv === "stainless steel") return "Stainless Steel"; if (lv.includes("nonstick") || lv.includes("marble") || lv.includes("diamond")) return "Nonstick"; if (lv.includes("ceramic")) return "Ceramic"; if (lv.includes("stainless")) return "Stainless Steel"; return "Nonstick"; };
    // Map features
    const featureMap = { "Auto Clean": "Auto Clean", "Turbo Mode": "Turbo Mode", "Voice Guide": "Voice Guide", "Water Capture": "Steamer Basket" };
    const mappedFeatures = product.features.filter(f => !f.startsWith("Preset Timer") && !f.startsWith("Voice Guide (")).map(f => featureMap[f] || f).filter(f => BK_CATEGORY_CONFIG.rice_cooker.features.includes(f));
  ...
  const generateBackendKeywords = useCallback(async () => {
    ...
    const timeoutId = setTimeout(() => bkAbort.abort("timeout"), 20000);
    ...
    try {
      ...
      const bkFetchPromise = fetch("https://api.anthropic.com/v1/messages", {
        method: "POST", headers: { "Content-Type": "application/json", "anthropic-beta": "interstitial-1" }, signal: bkAbort.signal,
        body: JSON.stringify({
      ...
      const bkTimeoutPromise = new Promise((_, reject) => setTimeout(() => reject(new Error("Request timed out (15s). Please retry.")), 15000));
      const res = await Promise.race([bkFetchPromise, bkTimeoutPromise]);
      if (!res.ok) { const errText = await res.text().catch(() => ""); throw new Error("API returned " + res.status + ": " + errText.slice(0, 200)); }
      const data = await res.json();
      if (data.error) throw new Error(data.error.message || "API error");
      const text = data.content?.map(i => i.type === "text" ? i.text : "").filter(Boolean).join("\n");
      ...
      if (e.name === "AbortError") {
        if (bkAbort.signal.reason === "timeout") {
          setBkError("Request timed out (20s). The API may be slow — please retry.");
        }
  ...
  const optimize = useCallback(async () => {
    ...
    try {
      ...
      const callApi = async (keys, skipAudit = false) => {
        const catRules = CATEGORY_RULES[categoryRef.current] || CATEGORY_RULES.other;
        const gl = keys.map(k => MARKETPLACES[k].guidelines).join("\n---\n");
        const auditNote = skipAudit ? "\nSKIP the amazon_audit — another request is handling it. Return amazon_audit as null." : "";
        const isModelMode = inputModeRef.current === "model";
        const userMsg = isModelMode
        ...
        const withTimeout = (fetchFn) => Promise.race([
          fetchFn(),
          new Promise((_, reject) => setTimeout(() => reject(new Error("Timed out after 30s — API did not respond.")), 30000))
        ]);
        let res;
        try {
          res = await withTimeout(makeRequest);
        } catch (firstErr) {
          if (firstErr.message.includes("did not respond")) {
            // one automatic retry
            res = await withTimeout(makeRequest);
          } else {
            throw firstErr;
      ...
      // Batch into 2 parallel calls if 6+ marketplaces — same as original
      let merged;
      if (sel.length >= 6) {
        const mid = Math.ceil(sel.length / 2);
        const [r1, r2] = await Promise.all([callApi(sel.slice(0, mid), false), callApi(sel.slice(mid), true)]);
        merged = { amazon_audit: r1.amazon_audit, conversions: { ...(r1.conversions || {}), ...(r2.conversions || {}) } };
      } else {
        merged = await callApi(sel);
      }
      ...
      } else if (e.message.includes("did not respond")) {
        setError("API not responding. Try reloading the page, then retry.");
      } else {
        setError(`${e.name}: ${e.message || "Something went wrong."}`);
      }
    } finally {
      clearTimeout(timeoutId);
      setLoading(false);
        ...
        <div style={{ background: "#fff", border: "1px solid #e8e5e0", borderRadius: 12, padding: 24, marginBottom: 16, boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
          ...
          {inputMode === "title" ? (
            ...
            <div>
              ...
              <div style={{ marginTop: 6, fontSize: 11, color: "#aaa", fontStyle: "italic" }}>The tool will use the internal product database to look up specs and generate titles from scratch.</div>
            </div>
          )}
          ...
          return (<>
            <button className="cuckoo-btn" disabled={bkDis}
              ...
              {bkLoading ? (<span style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10 }}>
                ...
                {bkElapsed < 5 ? "Generating keywords..." : bkElapsed < 10 ? "Almost there..." : bkElapsed < 15 ? "Taking longer than usual..." : "Still waiting — will timeout at 20s"}
            ...
            {bkLoading && (
              <div style={{ textAlign: "center", marginBottom: 12 }}>
                <div style={{ height: 4, background: "#f0eeeb", borderRadius: 2, overflow: "hidden", marginBottom: 8 }}>
                  <div style={{ width: `${Math.min(bkElapsed / 20 * 100, 100)}%`, height: `${bkElapsed >= 15 ? "100%" : "100%"}`, background: bkElapsed >= 15 ? "#d97706" : MAROON, borderRadius: 2, transition: "width 1s linear" }} />
                </div>
      ...
      {page === "product_compare" && <div style={{ maxWidth: 1060, margin: "0 auto", padding: "28px 24px 60px" }}>
        ...
        {compareModels.length >= 2 && (() => {
          ...
          const rows = [
            ...
            { label: "Special", key: "_feat_special", feat: true },
            { label: "ASIN", key: "asin" },
          ];
          const getVal = (m, row) => {
            ...
            if (row.feat) {
              ...
              if (row.key === "_feat_special") { const sf = m.features.find(f => !["Auto Clean","Turbo Mode","Water Capture"].includes(f) && !f.startsWith("Voice Guide") && !f.startsWith("Preset Timer")); return sf || "—"; }
